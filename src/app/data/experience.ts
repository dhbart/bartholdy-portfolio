...
export const experiences: Experience[] = [
  {
    company: 'Fruki Bebidas S.A.',
    location: 'Lajeado, RS — Brazil',
    period: 'Apr 2024 – Jan 2026',
    role: 'Solutions Supervisor / Tech Lead',
    summary:
  ...
  {
    company: 'Mercanet SFA',
    location: 'Caxias do Sul, RS — Brazil',
    period: 'Apr 2018 – Dec 2021',
    role: 'Business Analyst / Technical Consultant',
    summary:
